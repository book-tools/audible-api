...
export const searchCategories = {
  // Arts & Entertainment
  artsAndEntertainment: "18571910011",
  // Biographies & Memoirs
...
// publication_date
export const releaseTimes = {
  soon: "18685637011",
  last30: "18685638011",
  last90: "18685639011",
};

export const pageSizes = [20, 30, 40, 50];
...
export const audibleOriginal = {
  "feature_ten_browse-bin": "18685526011",
};

export const plusCatalog = {
  audible_programs: "20956260011",
};

export const whispersync = {
  "feature_three_browse-bin": "18685781011",
};

export const abridged = {
  "feature_nine_browse-bin": "18685523011",
};

export const unabridged = {
  "feature_nine_browse-bin": "18685524011",
};

export const audiobookFormat = {
  "feature_twelve_browse-bin": "18685552011",
};

export const podcastFormat = {
  "feature_twelve_browse-bin": "21201078011",
};

export const podcastShowFormat = {
  "feature_twenty-two_browse-bin": "21615422011",
};

export const podcastEpisodeFormat = {
  "feature_twenty-two_browse-bin": "21615423011",
};
